...
def extract_dob_college_img(regd):
    ...
    final_url = BET_E_PORTAL + "/StudentLogin/Student/StudentInformation.aspx"
    r = session.get(final_url, timeout=DEFAULT_TIMEOUT)
